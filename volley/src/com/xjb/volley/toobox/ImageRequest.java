...
import com.xjb.volley.Request.Method;
import com.xjb.volley.Request.Priority;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            ...
            if (entry != null) {
                entry.tag = ETAG.Image;
            }
            return Response.success(bitmap,entry);
        }
    }
	...
	@Override
	protected void deliverServerError(Bitmap response) {
