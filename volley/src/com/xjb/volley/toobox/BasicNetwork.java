...
import com.xjb.volley.Network;
import com.xjb.volley.NetworkError;
import com.xjb.volley.NetworkResponse;
import com.xjb.volley.NoConnectionError;
import com.xjb.volley.Request;
import com.xjb.volley.RetryPolicy;
import com.xjb.volley.ServerError;
import com.xjb.volley.TimeoutError;
import com.xjb.volley.VolleyError;
import com.xjb.volley.VolleyLog;
            ...
            try {
                ...
                if (httpResponse != null && httpResponse.getStatusLine() != null) {
                    ...
                    if (request.getCacheEntry() == null || request.getCacheEntry().data == null) {
                        ...
                        return new NetworkResponse(104, request.getCacheEntry().data, responseHeaders, true);
                    }
                }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                // This can happen if there was an exception above that left the entity in an invalid state.
